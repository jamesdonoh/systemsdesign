...
% TODO name object only when you reference them in messages (Ambler 2005, p.86) - trade off is having some named some anonymous objects which some people find confusing
